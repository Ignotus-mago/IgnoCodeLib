...
public class RandUtil {
	...
	/**
	 * Returns a random <code>int</code> in a range from high to low, inclusive.
	...
	/**
	 * Returns a random <code>float</code> in a range from high to low, inclusive.
	 * @param low     lower bound of range
	 * @param high    upper bound of range
	 * @return a random integer from low to high, inclusive.
	 */
	...
	/**
	 * Returns a random <code>double</code> in a range from high to low, inclusive.
	 * @param low    lower bound of range
	 * @param high    upper bound of range
	 * @return a random integer from low to high, inclusive.
	 */
